...
namespace WebApiJwt.Models
{
    public class CreateToken
    {
        ...
        public string TokenCreateAdmin()
        {
            ...
            JwtSecurityToken jwtsecuritytoken = new JwtSecurityToken(issuer: "http://localhost", audience: "http://localhost", notBefore: DateTime.Now, expires: DateTime.Now.AddSeconds(20), signingCredentials: credentials);
            JwtSecurityTokenHandler handler = new JwtSecurityTokenHandler();
